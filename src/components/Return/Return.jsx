  ...
  return (
    <div style={{ padding: "20px 30px", width: "60%", margin: "auto" }}>
      ...
      <p className="h2">
        ...
        <br />
        <br />
        Welcome to Starial Private Limited ("Company", "we", "our", "us")! These
        Terms of Service (“Terms”, “Terms of Service”) govern your use of our
        website located at https://www.starial.in (together or individually
        “Service”) operated by Starial Private Limited. Our Privacy Policy also
        ...
        Starialofficial@gmail.com so we can try to find a solution. These Terms
        ...
        Promotions, please make sure you have read as well as our Privacy
        ...
        <br />
        <br />
        1. You can only replace your order within 1 day of delivery.
        <br />
        2. Replacement Policy: If you are not happy with the product, please
        keep the product in the original packaging. In addition, the product
        must be unused and undamaged, with all the tags intact.
        <br />
        3. In case you are not available at delivery to check the quality of the
        product(s), you may raise a complaint within 2 hours of delivery.
        Similarly, in case any product is not delivered at the time of delivery,
        you may raise a complaint within 1 hour of delivery.
        <br />
        4. To pass feedback to the merchants to improve the services, it is
        mandatory to share the images of the product, in case you were
        dissatisfied with it. Subject to the approval from the third-party
        seller of the product, the Company may provide a replacement of the
        product and deliver the new product at the same address.
        <br />
        5. You can replace if the product got broken, cracked, or scratched
        under the pack. (This condition will apply when the customer complains
        about the product within 2 hours after getting the product, and the
        company will get back the product within 24 hours from the customer and
        send it to the vendor. After changing the same product, it will again be
        delivered to the customer.)
        <br />
        6. Few items listed may or may not carry a seller warranty to which
        Starial will support basis replacement policy.
        <br />
        7. Only one replacement can be done per sale.
        <br />
        <br />
        6. <b>Content</b>
        <br />
        ...
        by posting Content using Service you grant us the right and license to
        ...
        <br />
        <br />
        Starial Private Limited has the right but not the obligation to monitor
        and edit all Content provided by users.
        <br />
        <br />
        In addition, Content found on or through this Service is the property of
        Starial Private Limited or used with permission. You may not distribute,
