  ...
  return (
    ...
    >
      ...
      <div className="h2">
        ...
        <p>
          Welcome to Starial Private Limited ("Company", "we", "our", "us")!
          These Terms of Service ("Terms", "Terms of Service") govern your use
          of our website located at https://www.starial.in (together or
          individually "Service") operated by Starial Private Limited. Our
          ...
          Starialofficial@gmail.com so we can try to find a solution. These
        ...
        <p>
          ...
          card number, the expiration date of your card, your billing address,
          and your shipping information. You represent and warrant that: (i) you
          ...
          to us is true, correct and complete. We may employ the use of third
          ...
          our Privacy Policy. We reserve the right to refuse or cancel your
          order at any time for reasons including but not limited to: product or
        ...
        4. <h2>Contests, Sweepstakes and Promotions</h2>
        <p>
          <br />
          <br />
          ...
          any Promotions, Return Policy Terms of Service. If you participate in
          any Promotions, please make sure you have read as well as our Privacy
        ...
        5. <b>Returns & Replacement</b>
        <p>
          <br />
          <br />
          1. You can only replace your order within 1 days of delivery. 2.
          Replacement Policy: If you are not happy with the product, please keep
          the product in the original packaging. In addition, the product must
          be unused and undamaged, with all the tags intact. 3. In case you are
          not available at delivery to check the quality of the product(s), you
          may raise a complaint within 2 hours of delivery. Similarly, in case
          any product is not delivered at the time of delivery, you may raise a
          complaint within 1 hours of delivery. 4. To pass feedback to the
          merchants to improve the services, it is mandatory to share the images
          of the product, in case you were dissatisfied with. Subject to the
          approval from the third-party seller of the product, the Company may
          provide a replacement of the product and deliver the new product at
          the same address. 5. You can replace if product got broken, cracked,
          scratched under the pack. (this condition will apply when customer
          complain about product under 2 hours after getting product and company
          will get back the product under 24 hours from customer and send to
          vendor and after changing same product will again deliver to the
          customer. 5. Few items listed may or may not carry a seller warranty
          to which Starial will support basis replacement policy. 6. Only one
          replacement can be done per sale.
          <br />
        </p>
        6. <b>Content</b>
        <p>
          ...
          other users of the Service. Starial Private Limited has the right but
          ...
          of Starial Private Limited or used with permission. You may not
        ...
        <p>
          ...
          or disrupt any parts of the Service, the server on which Service is
        ...
        <p>
          ...
          seven (7) years old. By accessing or using Service, you warrant and
          represent that you are at least seven (7) years of age and with the
          full authority, right, and capacity to enter into this agreement and
          abide by all of the terms and conditions of Service. If you are not at
          least seven (7) years old, you are prohibited from both the access and
          usage of Service.
          <br />
        </p>
        ...
        <p>
          ...
          use as a username the name of another person or entity or that is not
        ...
        <p>
          ...
          property of Starial Private Limited and its licensors. Service is
          ...
          consent of Starial Private Limited.
          <br />
          <br />
          <br />
        </p>
        ...
        <p>
          ...
          Starialofficial@gmail.com, with the subject line: "Copyright
        ...
        <p>
          <br />
          <br />
          You may provide us either directly at Starialofficial@gmail.com or via
          ...
          and its affiliates an exclusive, transferable, irrevocable, free,
          worldwide, fully paid-up, unlimited and perpetual right to use
        ...
        <p>
          ...
          that are not owned or controlled by Starlet Private Limited. Starlet
          Private Limited has no control over, and assumes no responsibility for
          the content, privacy policies, or practices of any third party web
          sites or services. You further acknowledge and agree that Starlet
          Private Limited shall not be responsible or liable, directly or
          indirectly, for any damage or loss caused or alleged to be caused by
          or in connection with use of or reliance on any such content, goods or
          services available on or through any such web sites or services. For
          example, the outlined Terms of Use have been created using
          PolicyMaker.io, a free web application for generating high-quality
          legal documents. PolicyMaker's Terms and Conditions generator is an
        ...
        <p>
          ...
          OR ITEMS OBTAINED FROM US IS AT YOUR SOLE RISK. NEITHER COMPANY NOR
          ANY PERSON ASSOCIATED WITH COMPANY MAKES ANY WARRANTY OR
        ...
        <p>
          ...
          email: Starialofficial@gmail.com. These Terms of Service were created
          for https://www.starial.in/
        </p>
      </div>
    </div>
  );
